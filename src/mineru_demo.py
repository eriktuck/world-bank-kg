# See original at https://github.com/opendatalab/MinerU/blob/master/demo/demo.py
...
# from mineru.utils.guess_suffix_or_lang import guess_suffix_by_path  # NO MODULE FOUND
